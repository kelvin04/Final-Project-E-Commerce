...
import image3 from '../images/2ds-xl-2.png';
                ...
                <div className="container">
                    <div className="row">
                        ...
                        <div className="col-md-4 col-xs-6">
                            <div className="shop">
                                <div className="shop-img" style={{ textAlign:"center" }}>
                                    <img src={image2} alt="" style={{ width:"250px" }}/>
                                </div>
                                <div className="shop-body">
                        ...
                        <div className="col-md-4 col-xs-6">
                            <div className="shop">
                                <div className="shop-img" style={{ textAlign:"center", height: "250px" }}>
                                    <img src={image3} alt="" style={{ maxHeight: "200px", width: "auto", margin: "22px 0" }}/>
                                </div>
                                <div className="shop-body">
